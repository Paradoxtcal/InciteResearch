...
def build_graph(checkpointer=None):
    ...
    g.add_node("derivation_trace",      derivation_trace_node)
    g.add_node("method_lock",          method_lock_node)
    ...
    g.add_edge("story_arc",           "derivation_trace")
    g.add_edge("derivation_trace",    "method_lock")
    g.add_edge("method_lock",         "necessity_check")
